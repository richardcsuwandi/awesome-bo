...
Then read [Garnett's book](books.md) or [Terenin's draft](books.md) and install [Ax](https://ax.dev/) or [BoTorch](https://botorch.org/). Ax if you want a service-style API. BoTorch if you want to write the loop yourself on PyTorch.
